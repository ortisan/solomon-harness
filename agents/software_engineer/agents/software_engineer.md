...
- [plan_authoring](skills/plan_authoring.md) — Governs authoring PLAN.md between the Planning and Execution phases, covering the problem statement, proposed change, target-files fence, edge cases, a 3-to-8-step TDD breakdown, STRIDE notes, and checkable verification criteria. Use when starting a non-trivial feature or bugfix before writing any production code.
