...
- [git_flow_branches](skills/git_flow_branches.md) — Governs the branch model for this repository: a Git Flow topology where branch names carry a short slug and no issue number, and the issue…
