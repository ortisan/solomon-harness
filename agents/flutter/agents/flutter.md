...
- [common_pitfalls](skills/common_pitfalls.md) — The recurring Flutter defects a reviewer rejects on sight, from lifecycle misuse to leaked controllers and logic in widgets.
- [definition_of_done](skills/definition_of_done.md) — The completion gate for every Flutter change: what must hold before work is called done.
