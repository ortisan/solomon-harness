...
- [common_pitfalls](skills/common_pitfalls.md) — The review reject list for telemetry work: the metric, tracing, sampling, alerting, and dashboard defects that break the three-signal model.
- [definition_of_done](skills/definition_of_done.md) — The acceptance gate for observability deliverables: every item below must hold before instrumentation, alerting, or dashboards ship.
...
- [scope_and_non_negotiables](skills/scope_and_non_negotiables.md) — The binding project rules for every observability deliverable, with OpenTelemetry as the house telemetry standard.
