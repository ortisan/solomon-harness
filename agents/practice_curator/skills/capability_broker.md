...
- Sending `create_agent` through the reviewed-PR path — this changes the consumer repository for a harness-local registration and violates ADR-0041.
