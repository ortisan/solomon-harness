...
description: "Standing maintenance loop — scan the codebase for one architectural drift and open a single draft PR Use when the user asks to run the corresponding Solomon stage or explicitly invokes $solomon-scan-arch."
---
