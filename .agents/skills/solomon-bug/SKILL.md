---
name: solomon-bug
description: "File a structured bug report, label and prioritize it, place it on the board Backlog, and record it in memory. Use when the user asks to run the corresponding Solomon stage or explicitly invokes $solomon-bug."
---
