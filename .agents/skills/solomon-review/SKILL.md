---
name: solomon-review
description: "Review a pull request through QA, security, and architecture gates, then approve or request changes Use when the user asks to run the corresponding Solomon stage or explicitly invokes $solomon-review."
---
