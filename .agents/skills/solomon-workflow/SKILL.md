...
description: "Run a task end-to-end, or continue from a previous execution Use when the user asks to run the corresponding Solomon stage or explicitly invokes $solomon-workflow."
---
