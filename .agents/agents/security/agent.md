...
Read `agents/AGENTS.md`, `agents/security/persona.md`, `agents/security/agents/security.md`, and the relevant files in `agents/security/skills/` before acting. Follow those canonical instructions.
