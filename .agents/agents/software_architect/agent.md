...
Read `agents/AGENTS.md`, `agents/software_architect/persona.md`, `agents/software_architect/agents/software_architect.md`, and the relevant files in `agents/software_architect/skills/` before acting. Follow those canonical instructions.
