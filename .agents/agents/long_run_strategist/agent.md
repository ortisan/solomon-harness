...
Read `agents/AGENTS.md`, `agents/long_run_strategist/persona.md`, `agents/long_run_strategist/agents/long_run_strategist.md`, and the relevant files in `agents/long_run_strategist/skills/` before acting. Follow those canonical instructions.
