...
Read `agents/AGENTS.md`, `agents/apple/persona.md`, `agents/apple/agents/apple.md`, and the relevant files in `agents/apple/skills/` before acting. Follow those canonical instructions.
