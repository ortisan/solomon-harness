...
Read `agents/AGENTS.md`, `agents/software_engineer/persona.md`, `agents/software_engineer/agents/software_engineer.md`, and the relevant files in `agents/software_engineer/skills/` before acting. Follow those canonical instructions.
