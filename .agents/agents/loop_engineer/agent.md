...
Read `agents/AGENTS.md`, `agents/loop_engineer/persona.md`, `agents/loop_engineer/agents/loop_engineer.md`, and the relevant files in `agents/loop_engineer/skills/` before acting. Follow those canonical instructions.
