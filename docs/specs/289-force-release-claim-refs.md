...
`LoopLock`; it adds no lock or GitHub read. ADR-0035 defines the additional
...
- Reconciliation of reopened issues — out of scope for spec 264 for the same
  ...
  not a reconcile-pass question). ADR-0035 defines only how a ref version that
...
- Issue: #289
- ADR: `docs/adrs/0035-conditional-claim-ref-reconciliation.md` (amends
