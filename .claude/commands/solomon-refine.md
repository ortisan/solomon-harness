...
1b. **Capability Check**: Before starting refinement, verify the project has
    the capability (agent + skills) this issue needs. The deterministic router
    core builds the verdict (ADR-0008); you supply the match judgment as data —
    never build inline Python over issue text.
