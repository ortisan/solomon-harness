...
- `mcp__solomon-memory__log_handoff(sender="sre", recipient="done", contract_type="release", contract_path=".solomon/handoffs/release-vX.Y.Z-to-done.md", status="done")`; keep the returned handoff id.
